...
public class TestWindow : EditorWindow
{
    ...
    void SnapToSurface(GameObject gm, Vector3 dir)
    {
        ...
        if (renderer != null)
        {
            ...
            if (Physics.Raycast(renderer.bounds.center, dir, out rayhit))
            {
                ...
                //switch kan niet met een vector
                ...
                {
                    float yPos = rayhit.point.y + tmp * renderer.bounds.extents.y;
    ...
    void SnapAllToSurface(Vector3 dir)
    {
    ...
    void DrawSnapButtons()
    {

    }

    void DrawSnapButtonsExt()
    {
    ...
    void DuplicateInDirection(Vector3 dir)
    {
        foreach(GameObject gm in currentSelected)
        {
