...
public class PowerPoleManagerWindow : EditorWindow
{
    ...
    GameObject lastSelectedObject, currentSelectedObject;
    
    GameObject powerPolePrefab;
    ...
    void CreateNewPowerLine()
    {
        ...
        GameObject newPowerPole = Instantiate(powerPolePrefab, Vector3.zero, Quaternion.identity);
